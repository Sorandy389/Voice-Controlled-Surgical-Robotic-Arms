...
private:
    ...
    //new
    // vector<vector<float> > amp, zcr;
    // vector<vector<float> > voice_frame;
    

public:
    vector<vector<float> > getMFCCs(string filename);
    vector<vector<float> > getMFCCs(short* input, int len);
    ...
    //new
    // int x1, x2;
    // void endpoint(int16_t* input, int len);
    // vector<vector<float> > enframe(float* input, int len, int inc, int nx);
    // float* filter(float* input, float* filter, int len);
